...
class ControllerExtensionPaymentEripExpresspay extends Controller
{
  ...
  private function validate()
  {
    ...
    // Empty Token
    if(!isset($this->request->post['eripExpressPayToken']))
    {
      $this->error['eripExpressPayToken'] = $this->language->get('eripExpressPayTokenError');
    }
    //Empty ServiceId
    if(!isset($this->request->post['eripExpressPayServiceId']))
    {
      $this->error['eripExpressPayServiceId'] = $this->language->get('eripExpressPayServiceIdError');
    }
    */
    return true;
  }
